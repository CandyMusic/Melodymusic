...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: AbhiXCandy (@VeNom_HAi_HuM @its_alone_candy)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        try:
            ...
            title = "NaN"
            thumb_name = "https://telegra.ph//file/ed2a67d9a991a85daf95d.jpg"
            duration = "NaN"
            views = "NaN"
            keyboard = InlineKeyboardMarkup(
            [
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph//file/4e69566873301f22c5f94.jpg", 
                             caption="**💥 ɱɛƖơɖყ 🔈 Mʋsɩƈ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**💥 ɱɛƖơɖყ 💞 Ɲøʈɦɩɳʛ 🔇\n🚫 Ƥɭɑyɩɳʛ 🌷 ...**")
    else:
